...
(function() {
  $($(function() {
    var continue_task, current_task, display_image, display_task, end_write_task, format_time, load_next_task, load_saved_task, next_task, ready_task, save_task, set_background_blur, share_options, start_task, update_countdown, write_task;
    ...
    end_write_task = function() {
      $('#taskdisplay').removeAttr('contenteditable').blur();
      return current_task.title = $('#taskdisplay').text();
    };
